...
with open("candidates_q.json", "r") as f:
    candidates_q = json.load(f)
score = abs(candidates_q[1][0])
v, ers = candidates_q[1][1]
print("Best candidate for q:", v, "with score", score)
